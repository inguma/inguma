...
#        renderer_text.set_property("markup", 1)
    ...
    def popup_stack(self, widget):
        ...
        stack_img = gtk.Image()
        stack_img.set_from_file('lib' + os.sep + 'ui' + os.sep + 'bokken' + os.sep + 'data' + os.sep + 'stack.png')
    ...
    def popup_registers(self, widget):
        ...
        dialog.set_icon_from_file(os.path.dirname(__file__) + os.sep + 'data' + os.sep + 'bokken.svg')
        reg_img = gtk.Image()
        reg_img.set_from_file('lib' + os.sep + 'ui' + os.sep + 'bokken' + os.sep + 'data' + os.sep + 'registers.png')
