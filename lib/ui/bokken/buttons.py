...
class TopButtons(gtk.HBox):
    ...
    def __init__(self, core, main):
        ...
        b = gtk.Button()
        i = gtk.Image()
        pixbuf = gtk.gdk.pixbuf_new_from_file('lib' + os.sep + 'ui' + os.sep + 'bokken' + os.sep +'data' + os.sep + 'response-headers.png')
        ...
        b = gtk.Button()
        i = gtk.Image()
        pixbuf = gtk.gdk.pixbuf_new_from_file('lib' + os.sep + 'ui' + os.sep + 'bokken' + os.sep +'data' + os.sep + 'response-body.png')
        scaled_buf = pixbuf.scale_simple(24,24,gtk.gdk.INTERP_BILINEAR)
        i.set_from_pixbuf(scaled_buf)
        b.set_image(i)
        ...
        b = gtk.Button()
        i = gtk.Image()
        pixbuf = gtk.gdk.pixbuf_new_from_file('lib' + os.sep + 'ui' + os.sep + 'bokken' + os.sep +'data' + os.sep + 'request-body.png')
        scaled_buf = pixbuf.scale_simple(24,24,gtk.gdk.INTERP_BILINEAR)
        i.set_from_pixbuf(scaled_buf)
        b.set_image(i)
