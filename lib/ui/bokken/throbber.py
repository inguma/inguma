...
class Throbber(gtk.ToolButton):
    ...
    def __init__(self):
        ...
        self.img_static.set_from_file('lib' + os.sep + 'ui' + os.sep + 'bokken' + os.sep + 'data' + os.sep +'throbber_static.gif')
        self.img_static.show()
        self.img_animat = gtk.Image()
        self.img_animat.set_from_file('lib' + os.sep + 'ui' + os.sep + 'bokken' + os.sep + 'data' + os.sep + 'throbber_animat.gif')
