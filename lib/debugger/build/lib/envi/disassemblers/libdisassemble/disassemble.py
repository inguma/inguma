...
class Register(Mode):
    def __init__(self, regndx, type=opcode86.OP_REG):
        ...
        self.visireg = regndx % 8 #HACK: visi storing stuff... this only works with GP regs
        self.visiregoff = regndx / 8
...
class Address(Mode):
    def __init__(self, data, length, type=opcode86.ADDEXP_DISP_OFFSET, signed=1, relative=False):
        Mode.__init__(self, type)
