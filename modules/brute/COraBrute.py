...
class COraBrute(CIngumaBruteModule):
    ...
    def help(self):
        ...
        self.gom.echo("sid = <sid>")
        print
        self.gom.echo("Optional:")
        self.gom.echo("user = <username>")
        print
        self.gom.echo("If you don't specify the username the most common users will be checked")
        print
    ...
    def brute_force(self):
        ...
        for user in userList:
            for passwd in self.getPasswordList(self.dict['base_path']):
                ...
                try:
                    ...
                    self.add_data_to_kb(self.target + "_passwords", user + "/" + passwd)
