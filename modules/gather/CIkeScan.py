...
class CIkeScan(CIngumaGatherModule):
        ...
        if not ans:
            ...
            for s, r in ans:
                if r.haslayer(ISAKMP_payload_VendorID):
                    ...
                    self.add_data_to_kb("hosts", r.src)
                    return True
                else:
    ...
    def print_summary(self):
        ...
        for host in self.vendorID:
            ...
            self.add_data_to_kb(self.target + "_ikevendor", vendor)
            self.add_data_to_kb(self.target + "_ikefingerprinting", fingerprinting)
