...
from impacket.dcerpc import dcerpc, transport, samr
...
class CSamrDump(CIngumaGatherModule):
    ...
    def help(self):
        ...
        self.gom.echo("username = <username>")
...
class SAMRDump:
    ...
    def dump(self, addr):
        ...
        for entry in entries:
            ...
            if user.is_enabled():
                self.add_data_to_kb(addr + "_users", username.replace("\x00", ""))
