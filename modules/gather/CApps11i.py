...
class CApps11i(CIngumaGatherModule):
    ...
    def help(self):
        ...
        self.gom.echo("dad = <DAD name>")
        self.gom.echo()
        self.gom.echo("If the DAD is not specified it will be guessed.")
    ...
    def getDAD(self):
        ...
        self.add_data_to_kb(self.target + "_dad", self.dadName)
        return(self.dadName)
    ...
    def getSysdate(self):
        ...
        self.add_data_to_kb(self.target + "_sysdate", mDate)
    ...
    def getDatabaseVersion(self):
        ...
        self.add_data_to_kb(self.target + "_database_version", self.version)
        return(self.version)
    ...
    def getDatabaseSid(self):
        ...
        self.add_data_to_kb(self.target + "_database_id", self.sid)
        return(self.sid)
    ...
    def getSchemaName(self):
        ...
        self.add_data_to_kb(self.target + "_schema_name", self.schemaName)
    ...
    def getAOLVersion(self):
        ...
        self.add_data_to_kb(self.target + "_aol_version", self.aolVersion)
    ...
    def getAppsWebAgent(self):
        ...
        self.add_data_to_kb(self.target + "_apps_web_agent", self.webAgent)
    ...
    def getInternalHostnamePort(self, informationJsp):
        ...
        self.add_data_to_kb(self.target + "_internal_db_host", self.databaseHost)
        self.add_data_to_kb(self.target + "_internal_db_host", self.databasePort)
    ...
    def getLoginFormPath(self):
        ...
        self.add_data_to_kb(self.target + "_login_form", self.loginForm)
    ...
    def getProdComnPath(self):
        ...
        try:
            ...
            self.add_data_to_kb(self.target + "_prod_comn_path", self.prodComnPath)
        except:
